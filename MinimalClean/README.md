...
# Run the application
dotnet run --project src/MinimalKlinikGigiV2.Web

# Or run with Aspire (if using)
dotnet run --project src/MinimalKlinikGigiV2.AspireHost
```
...
```powershell
dotnet ef database update -c AppDbContext -p src/MinimalKlinikGigiV2.Web -s src/MinimalKlinikGigiV2.Web
dotnet run --project src/MinimalKlinikGigiV2.Web
```
