...
**Updated `tests\KlinikGigiV2.FunctionalTests\KlinikGigiV2.FunctionalTests.csproj`:**
- Removed: `Microsoft.EntityFrameworkCore.InMemory`
- Added: `Testcontainers` and `Testcontainers.MsSql`

### 2. CustomWebApplicationFactory

**File:** `tests\KlinikGigiV2.FunctionalTests\CustomWebApplicationFactory.cs`
...
```bash
dotnet test tests\KlinikGigiV2.FunctionalTests\KlinikGigiV2.FunctionalTests.csproj
```
